    ...
    <div className="analysis-container">
      ...
      <main className="analysis-content">
        ...
        <div className="download-container">
          <a href="http://127.0.0.1:8000/download/analysis_output.csv" download target="_blank" rel="noopener noreferrer">
      <button className="download-button">Download Analysis CSV</button>
      </a>
        </div>
